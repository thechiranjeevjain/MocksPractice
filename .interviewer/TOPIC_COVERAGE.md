...
No completed sessions yet. `Sessions since tested` may not exceed 3; coverage debt influences selection but cannot create a zero-exposure curveball.
...
| LLD | none | 0 | UNASSESSED |
| HLD | none | 0 | UNASSESSED |
| Project depth | none | 0 | UNASSESSED |
| Behavioral/leadership | none | 0 | UNASSESSED |
